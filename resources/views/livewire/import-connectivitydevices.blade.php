                ...
                <div class="mt-2 flex items-center justify-center w-full">
                    <label for="upload" class="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100">
                         <div class="flex flex-col items-center justify-center pt-5 pb-6">
                             ...
                             <p class="text-xs text-gray-500">.csv, .xls (max: 50k)</p>
                         </div>
                         <input id="upload" wire:model="upload" accept=".csv,.xls,.xlsx" type="file" class="hidden" />
                     </label>
                </div>
                ...
                @else
                    @unless(count($importFailures))
                        <x-forms.import-select>
                            <x-slot name="label">
                                <x-forms.label name="fieldColumnMap.full_name" label="Teljes név" :error="$errors->first('fieldColumnMap.full_name')"></x-forms.label>
                            </x-slot>
                            <x-slot name="select">
                        ...
                        <x-forms.import-select>
                            <x-slot name="label">
                                <x-forms.label name="fieldColumnMap.start" label="Kezdőpont" :error="$errors->first('fieldColumnMap.start')"></x-forms.label>
                            </x-slot>
                            <x-slot name="select">
                        ...
                        <x-forms.import-select>
                            <x-slot name="label">
                                <x-forms.label name="fieldColumnMap.end" label="Végpont" :error="$errors->first('fieldColumnMap.start')"></x-forms.label>
                            </x-slot>
                            <x-slot name="select">
                        ...
                        <x-forms.import-select>
                            <x-slot name="label">
                                <x-forms.label name="type" label="Típus"></x-forms.label>
                            </x-slot>
                            <x-slot name="select">
                        ...
                        <x-forms.import-select>
                            <x-slot name="label">
                                <x-forms.label name="owner" label="Tulajdonos"></x-forms.label>
                            </x-slot>
                            <x-slot name="select">
