<x-card>
    <a href="#">
        <img class="rounded-t-lg" src="{{ asset('images/users.jpeg') }}" alt="{{ __('Users') }}" />
    </a>
    <div class="p-5">
        <a href="#">
            <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{{ __('Users') }}</h5>
        </a>
