                ...
                <div class="p-6 text-gray-900">
                    ...
                    <x-table>
                        <x-slot name="head">
                            ...
                            <x-table.heading>Kapcsolati eszközök</x-table.heading>
                        </x-slot>
                        <x-slot name="body">
                            @foreach ($locations as $location)
                                @foreach ($location->zones as $zone)
                                    <x-table.row>
                                        ...
                                        <x-table.cell>
                                            @isset($location->number_of_connectivity_devices_by_zone[$zone->id])
                                                {{ $location->number_of_connectivity_devices_by_zone[$zone->id] }}
                                            @else
                                                0
                                            @endisset
                                        </x-table.cell>
