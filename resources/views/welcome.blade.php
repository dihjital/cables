...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <div class="min-h-screen bg-gray-100 dark:bg-gray-900">
        ...
        <div class="h-screen w-screen content-around grid px-10 grid-cols-4 gap-4">
            ...
            <x-cards.users>
                A rendszer biztosítja felhasználók rögzítését és szerkesztését: beállítható, hogy mely felhasználók aktívak vagy inaktívak, illet, hogy melyek rendelkeznek adminisztrátori jogokkal.
            </x-cards.users>
        </div>
