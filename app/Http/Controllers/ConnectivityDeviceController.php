...
class ConnectivityDeviceController extends Controller
{

    public function index() {

        return view('connectivity_devices.index', [
            'connectivity_devices' => ConnectivityDevice::latest()
                ->with(['location', 'zone', 'owner', 'connectivity_device_type'])
                ->paginate(15)
                ->withQueryString()
        ]);
    ...
    public function store() {
        ...
        return redirect()->back()->with('success', 'Kapcsolati eszköz létrehozása sikeres');
